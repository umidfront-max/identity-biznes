...
const validateNameMessage = (rule: any, value: any, callback: any) => {
  if (!value) {
    callback(new Error(t('management_roles.messages.enter_name')))
  } else {
    callback()
  }
}
const validatePercentMessage = (rule: any, value: any, callback: any) => {
  if (!value) {
    callback(new Error(t('management_roles.messages.enter_percent')))
  } else {
    callback()
  }
}
const validateMinAmountMessage = (rule: any, value: any, callback: any) => {
  if (!value) {
    callback(new Error(t('management_roles.messages.enter_min_amount')))
  } else {
    callback()
  }
}
