...
/**
 * @description Convert array of parent-child relationship into tree structure data
 * @param data
 * @returns {*}
 */
...
/**
 * @description Convert tree structure data into an array with parent-child relationship
 * @param data
 * @returns {[]}
 */
...
/**
 * @description 10-digit timestamp conversion
 * @param time
 * @returns {string}
 */
...
/**
 * @description 13-bit timestamp conversion
 * @param time
 * @returns {string}
 */
...
/**
 * @description Random number from m to n
 * @param m
 * @param n
 * @returns {number}
 */
