...
.vab-header .vab-main .right-panel {
  .el-menu.el-menu--horizontal {
    width: calc(100vw * 0.92 - 295px - 465px) !important;
  }
}
</style>
...
/* custom style? */
.vab-header .vab-main .right-panel[data-v-3b4a87a2] {
  padding-right: 5px;
  padding-left: 5px;
}
.vab-header .vab-main .right-panel[data-v-3b4a87a2] [class*='ri-'] {
  margin-left: 0 !important;
  color: var(--el-menu-text-color) !important;
}
.vab-header .vab-main .right-panel[data-v-3b4a87a2] .username {
  color: var(--el-menu-text-color) !important;
}
</style>
