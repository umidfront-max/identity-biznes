...
watchEffect(() => {
  ...
  siteData.description = `${'Vue'} ${'Shop'} ${'Vite'}-${route.meta.title}Introduction, official website, homepage, documentation and downloads - front-end development framework`
})
